...
# SPECIALIZED FOR EASY PROBLEMS ONLY (difficulty 0-9) - 327 training samples
# MODEL: Llama-3.1-8B-Instruct (converted from Qwen2.5-Math-7B)
...
# =============================================================================
export REWARD_MODEL_TYPE=RULE_BASED                        # Rule-based scoring for all modes
...
# Mode-specific DEBUG and naming - EASY PROBLEMS ONLY - LLAMA 3.1 8B
if [ "$TRAINING_MODE" = "MODE1" ]; then
export DEBUG=True
export EXPERIMENT_NAME=debug_llama_3_1_8b_rule_based_easy_only_novel
export PROJECT_NAME='debug_llama_3_1_8b_rule_based_easy_only_novel'
export RAY_HEAD_PORT=6388
elif [ "$TRAINING_MODE" = "MODE2" ]; then
export DEBUG=False
export EXPERIMENT_NAME=prod_llama_3_1_8b_rule_based_easy_only_novel
export PROJECT_NAME='prod_llama_3_1_8b_rule_based_easy_only_novel'
export RAY_HEAD_PORT=6388
else  # MODE3
export DEBUG=False
export EXPERIMENT_NAME=remote_m_family_8b_rule_based_327_sample_diff_0_615_epoch
export PROJECT_NAME='m_family_8b_rule_based_327_sample_diff_0_615_epoch'
export RAY_HEAD_PORT=6375
fi
# =============================================================================
...
if [ "$TRAINING_MODE" = "MODE1" ]; then
export BASE_MODEL=/local2/salman/model/Llama-3.1-8B-Instruct               # Debug: Llama-3.1-8B-Instruct
elif [ "$TRAINING_MODE" = "MODE2" ]; then
export BASE_MODEL=/local2/salman/model/Llama-3.1-8B-Instruct               # Production: Llama-3.1-8B-Instruct
else
export BASE_MODEL=/checkpoints/salsrahm-sandbox/model_family/Llama-3.1-8B-Instruct      # Remote: Llama-3.1-8B-Instruct
fi
...
BASE_SAVE_PATH="/local2/salman/co_train_llama_3_1_8b/rlvr_only_easy_327_diff_0_615_epoch"
else
BASE_SAVE_PATH="/checkpoints/salsrahm-sandbox/novel_hybrid_model_family/$PROJECT_NAME"
fi
...
# Mode-specific training data paths - EASY PROBLEMS ONLY
if [ "$TRAINING_MODE" = "MODE1" ]; then
TRAIN_DATA_PATH="/home/salman/open-prm/data-skymath/rl_training_data/novel_hybrid/rl_training_no_step_instruction/easy_hard_train_data/easy_train_novel_hybrid_4k_with_gt.parquet"
EVAL_DATA_PATH_1="/home/salman/open-prm/data-skymath/rl_training_data/novel_hybrid/rl_training_no_step_instruction/eval_data/amc_test.parquet"
CUSTOM_REWARD_PATH="/home/salman/verl/salman_scripts_novel_hybrid/novel_math_gen_rm_reward_function.py"
elif [ "$TRAINING_MODE" = "MODE2" ]; then
TRAIN_DATA_PATH="/home/salman/open-prm/data-skymath/rl_training_data/novel_hybrid/rl_training_no_step_instruction/easy_hard_train_data/by_difficulty/train_novel_hybrid_diff_0_327.parquet"
...
EVAL_DATA_PATH_4="/home/salman/open-prm/data-skymath/rl_training_data/novel_hybrid/rl_training_no_step_instruction/eval_data/amc_test.parquet"
CUSTOM_REWARD_PATH="/home/salman/verl/salman_scripts_novel_hybrid/novel_math_gen_rm_reward_function.py"
else
# TRAIN_DATA_PATH="/checkpoints/salsrahm-sandbox/z_novel_rl_data_no_step_instruction/easy_hard_split/easy_train_novel_hybrid_4k_with_gt.parquet"
TRAIN_DATA_PATH="/checkpoints/salsrahm-sandbox/z_novel_rl_data_no_step_instruction/by_difficulty/train_novel_hybrid_diff_0_327.parquet"
...
EVAL_DATA_PATH_4="/checkpoints/salsrahm-sandbox/z_novel_rl_data_no_step_instruction/eval_data/amc_test.parquet"
