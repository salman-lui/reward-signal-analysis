...
# FULL DATASET - 8K training samples (all difficulty levels)
...
# =============================================================================
export REWARD_MODEL_TYPE=MAJORITY_50_DIFFICULT_RULE_50_EASY                        # Hybrid: Easy=Rule-based, Difficult=TTRL majority voting
...
# Mode-specific DEBUG and naming - FULL DATASET - LLAMA 3.1 8B - 8K SAMPLES - HYBRID
if [ "$TRAINING_MODE" = "MODE1" ]; then
export DEBUG=True
export EXPERIMENT_NAME=debug_llama_3_1_8b_majority_50_difficult_rule_50_easy
export PROJECT_NAME='debug_llama_3_1_8b_majority_50_difficult_rule_50_easy'
export RAY_HEAD_PORT=6388
elif [ "$TRAINING_MODE" = "MODE2" ]; then
export DEBUG=False
export EXPERIMENT_NAME=prod_llama_3_1_8b_majority_50_difficult_rule_50_easy
export PROJECT_NAME='prod_llama_3_1_8b_majority_50_difficult_rule_50_easy'
export RAY_HEAD_PORT=6388
else  # MODE3
export DEBUG=False
export EXPERIMENT_NAME=remote_m_family_8b_majority_50_difficult_rule_50_easy
export PROJECT_NAME='m_family_8b_majority_50_difficult_rule_50_easy'
export RAY_HEAD_PORT=6392
fi

# TTRL Configuration for Majority Voting (Difficult Problems Only)
# TTRL is automatically enabled for difficult problems (10-16) in hybrid mode
if [ "$TRAINING_MODE" = "MODE1" ]; then
...
BASE_SAVE_PATH="/local2/salman/co_train_llama_3_1_8b/easy_50_rule_hard_50_majority"
else
BASE_SAVE_PATH="/checkpoints/salsrahm-sandbox/novel_hybrid_model_family/easy_50_rule_hard_50_majority"
fi
...
# Mode-specific training data paths - FULL DATASET - 8K SAMPLES
if [ "$TRAINING_MODE" = "MODE1" ]; then
...
TRAIN_DATA_PATH="/checkpoints/salsrahm-sandbox/z_novel_rl_data_no_step_instruction/train_novel_hybrid_8k_with_gt.parquet"
