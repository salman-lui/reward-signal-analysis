...
# SPECIALIZED FOR EASY PROBLEMS ONLY (difficulty 0-9) - 4K training samples
...
# Mode-specific DEBUG and naming - EASY PROBLEMS ONLY - LLAMA 3.1 8B - 4K SAMPLES
if [ "$TRAINING_MODE" = "MODE1" ]; then
export DEBUG=True
export EXPERIMENT_NAME=debug_llama_3_1_8b_rule_based_easy_4k_novel
export PROJECT_NAME='debug_llama_3_1_8b_rule_based_easy_4k_novel'
export RAY_HEAD_PORT=6388
elif [ "$TRAINING_MODE" = "MODE2" ]; then
export DEBUG=False
export EXPERIMENT_NAME=prod_llama_3_1_8b_rule_based_easy_4k_novel
export PROJECT_NAME='prod_llama_3_1_8b_rule_based_easy_4k_novel'
export RAY_HEAD_PORT=6388
else  # MODE3
export DEBUG=False
export EXPERIMENT_NAME=remote_m_family_8b_rule_based_easy_4k_615_epoch
export PROJECT_NAME='m_family_8b_rule_based_easy_4k_615_epoch'
...
BASE_SAVE_PATH="/local2/salman/co_train_llama_3_1_8b/rlvr_only_easy_4k_615_epoch"
else
...
# Mode-specific training data paths - EASY PROBLEMS ONLY - 4K SAMPLES
if [ "$TRAINING_MODE" = "MODE1" ]; then
