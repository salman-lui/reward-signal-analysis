...
# Mode-specific DEBUG and naming - FULL DATASET - LLAMA 3.1 8B - 8K SAMPLES
if [ "$TRAINING_MODE" = "MODE1" ]; then
export DEBUG=True
export EXPERIMENT_NAME=debug_llama_3_1_8b_rule_based_full_8k_novel
export PROJECT_NAME='debug_llama_3_1_8b_rule_based_full_8k_novel'
export RAY_HEAD_PORT=6388
elif [ "$TRAINING_MODE" = "MODE2" ]; then
export DEBUG=False
export EXPERIMENT_NAME=prod_llama_3_1_8b_rule_based_full_8k_novel
export PROJECT_NAME='prod_llama_3_1_8b_rule_based_full_8k_novel'
export RAY_HEAD_PORT=6388
else  # MODE3
export DEBUG=False
export EXPERIMENT_NAME=remote_m_family_8b_rule_based_full_8k_novel
export PROJECT_NAME='m_family_8b_rule_based_full_8k_novel'
export RAY_HEAD_PORT=6389
fi
# =============================================================================
...
BASE_SAVE_PATH="/local2/salman/co_train_llama_3_1_8b/rlvr_full_8k"
else
BASE_SAVE_PATH="/checkpoints/salsrahm-sandbox/novel_hybrid_model_family/rlvr_full_8k"
fi
