...
cd /home/salman/verl
export REWARD_MODEL_TYPE=MAJORITY_VOTE
...
if [ "$DEBUG" = "True" ]; then
    export TTRL_N_VOTES_PER_PROMPT=4         # Generate 8 responses for voting (debug mode)
...
# MAJORITY_VOTE Configuration - TTRL-style Training
# Generate 32 responses for majority voting, then use 8 for PPO training
# Self-supervised learning through majority consensus
...
BASE_SAVE_PATH="/local2/salman/co-training/full_unsupervised/only_majority_vote_training"
PROJECT_NAME='only_majority_vote_ttrl'
EXPERIMENT_NAME='salsrahm_only_majority_vote_ttrl_training'
...
# MAJORITY_VOTE Training - TTRL-style Majority Voting
