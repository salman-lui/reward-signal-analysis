...
cd /home/salman/verl
export REWARD_MODEL_TYPE=MAJORITY_50_DIFFICULT_RULE_50_EASY

# TTRL Configuration for Majority Voting (Easy Problems)
# TTRL is automatically enabled for easy problems (difficulty 0-9) in hybrid mode
...
# MAJORITY_50_DIFFICULT_RULE_50_EASY Configuration - Hybrid Training
# Easy problems (0-9): Rule-based rewards using original ground truth
# Hard problems (10-16): TTRL-style majority voting
...
BASE_SAVE_PATH="/local2/salman/co-training/hybrid_training/easy_50_rule_hard_50_majority"
PROJECT_NAME='majority_50_difficult_rule_50_easy'
EXPERIMENT_NAME='salsrahm_majority_50_difficult_rule_50_easy'
...
# MAJORITY_50_DIFFICULT_RULE_50_EASY Training - Hybrid Approach
# Easy problems: Rule-based rewards, Hard problems: TTRL-style majority voting
