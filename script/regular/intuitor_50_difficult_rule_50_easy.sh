...
cd /home/salman/verl
export REWARD_MODEL_TYPE=INTUITOR_50_DIFFICULT_RULE_50_EASY  
...
# INTUITOR_50_DIFFICULT_RULE_50_EASY Configuration - Hybrid Reward Training
# Easy problems (difficulty 0-9): Rule-based rewards (math_verify)
# Difficult problems (difficulty 10-16): Self-certainty rewards (INTUITOR)
# No external reward model needed for self-certainty part
...
BASE_SAVE_PATH="/local2/salman/co-training/hybrid_training/easy_50_rule_hard_50_self_certainty"
PROJECT_NAME='intuitor_50_difficult_rule_50_easy'
EXPERIMENT_NAME='salsrahm_hybrid_easy_rule_difficult_self_certainty'
