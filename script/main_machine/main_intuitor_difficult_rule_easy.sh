...
if [ "$TRAINING_MODE" = "MODE1" ] || [ "$TRAINING_MODE" = "MODE2" ]; then
    export CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES:-"1,2,3,4"}  # 6 GPUs to match reference
fi
...
# =============================================================================
export REWARD_MODEL_TYPE=INTUITOR_50_DIFFICULT_RULE_50_EASY                        # Self-certainty based scoring for all modes
...
if [ "$TRAINING_MODE" = "MODE1" ]; then
    export DEBUG=True
    export EXPERIMENT_NAME=debug_easy_rule_difficult_self_certainty
    export PROJECT_NAME='debug_easy_rule_difficult_self_certainty'
    export RAY_HEAD_PORT=6388
elif [ "$TRAINING_MODE" = "MODE2" ]; then
    export DEBUG=False
    export EXPERIMENT_NAME=prod_easy_rule_difficult_self_certainty
    export PROJECT_NAME='prod_easy_rule_difficult_self_certainty'
    export RAY_HEAD_PORT=6388
else  # MODE3
    export DEBUG=False
    export EXPERIMENT_NAME=remote_easy_rule_difficult_self_certainty
    export PROJECT_NAME='remote_easy_rule_difficult_self_certainty'
    export RAY_HEAD_PORT=6391
fi
# =============================================================================
...
if [ "$TRAINING_MODE" = "MODE1" ]; then
    ...
    BASE_SAVE_PATH="/local2/salman/co_train_qwen_2_5_math/easy_rule_difficult_self_certainty"
else
    BASE_SAVE_PATH="/checkpoints/salsrahm-sandbox/novel_hybrid/easy_rule_difficult_self_certainty"
fi
