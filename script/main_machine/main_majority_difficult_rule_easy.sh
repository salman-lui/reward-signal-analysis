...
# Set your mode here:
export TRAINING_MODE=${TRAINING_MODE:-"MODE1"}  # Default to MODE1, can be overridden by environment
...
# Mode-specific DEBUG and naming
if [ "$TRAINING_MODE" = "MODE1" ]; then
    export DEBUG=True
    export EXPERIMENT_NAME=debug_majority_50_difficult_rule_50_easy
    export PROJECT_NAME='debug_majority_50_difficult_rule_50_easy'
    export RAY_HEAD_PORT=6388
elif [ "$TRAINING_MODE" = "MODE2" ]; then
    export DEBUG=False
    export EXPERIMENT_NAME=prod_majority_50_difficult_rule_50_easy
    export PROJECT_NAME='prod_majority_50_difficult_rule_50_easy'
    export RAY_HEAD_PORT=6388
else  # MODE3
    export DEBUG=False
    export EXPERIMENT_NAME=remote_majority_50_difficult_rule_50_easy
    export PROJECT_NAME='remote_majority_50_difficult_rule_50_easy'
    export RAY_HEAD_PORT=6395
fi
...
if [ "$TRAINING_MODE" = "MODE1" ]; then
    ...
    BASE_SAVE_PATH="/local2/salman/co_train_qwen_2_5_math/easy_50_rule_hard_50_majority"
else
    BASE_SAVE_PATH="/checkpoints/salsrahm-sandbox/novel_hybrid/easy_50_rule_hard_50_majority"
fi
...
# Mode-specific training data paths
if [ "$TRAINING_MODE" = "MODE1" ]; then
