...
# Set your mode here:
export TRAINING_MODE=${TRAINING_MODE:-"MODE2"}  # Default to MODE1, can be overridden by environment
...
# Mode-specific DEBUG and naming - EASY PROBLEMS ONLY
if [ "$TRAINING_MODE" = "MODE1" ]; then
  export DEBUG=True
  export EXPERIMENT_NAME=debug_rule_based_easy_only_novel
  export PROJECT_NAME='debug_rule_based_easy_only_novel'
  export RAY_HEAD_PORT=6388
elif [ "$TRAINING_MODE" = "MODE2" ]; then
  export DEBUG=False
  export EXPERIMENT_NAME=prod_rule_based_easy_only_novel
  export PROJECT_NAME='prod_rule_based_easy_only_novel'
  export RAY_HEAD_PORT=6388
else  # MODE3
  export DEBUG=False
  export EXPERIMENT_NAME=remote_rule_based_easy_only_cluster_novel
  export PROJECT_NAME='rule_based_easy_only_novel'
...
if [ "$TRAINING_MODE" = "MODE1" ]; then
  ...
  BASE_SAVE_PATH="/local2/salman/co_train_qwen_2_5_math/rlvr_only_easy_4k"
else
  BASE_SAVE_PATH="/checkpoints/salsrahm-sandbox/novel_hybrid/rlvr_only_easy_4k"
fi
