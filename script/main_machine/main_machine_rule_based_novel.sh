...
if [ "$TRAINING_MODE" = "MODE1" ]; then
    export DEBUG=True
    export EXPERIMENT_NAME=debug_rule_based_local_novel
    export PROJECT_NAME='debug_rule_based_local_novel'
    export RAY_HEAD_PORT=6388
elif [ "$TRAINING_MODE" = "MODE2" ]; then
    export DEBUG=False
    export EXPERIMENT_NAME=prod_rule_based_local_novel
    export PROJECT_NAME='prod_rule_based_local_novel'
    export RAY_HEAD_PORT=6388
else  # MODE3
    export DEBUG=False
    export EXPERIMENT_NAME=remote_rule_based_cluster_novel
    export PROJECT_NAME='remote_rule_based_cluster_novel'
...
if [ "$TRAINING_MODE" = "MODE1" ]; then
    ...
    BASE_SAVE_PATH="/local2/salman/co_train_qwen_2_5_math/rlvr"
else
    BASE_SAVE_PATH="/checkpoints/salsrahm-sandbox/novel_hybrid/rlvr"
fi
