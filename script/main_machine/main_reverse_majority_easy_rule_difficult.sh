...
# =============================================================================
export REWARD_MODEL_TYPE=REVERSE_MAJORITY_50_EASY_RULE_50_DIFFICULT                        # Reverse Hybrid: Easy=TTRL majority voting, Difficult=Rule-based
...
if [ "$TRAINING_MODE" = "MODE1" ]; then
    export DEBUG=True
    export EXPERIMENT_NAME=debug_reverse_majority_50_easy_rule_50_difficult
    export PROJECT_NAME='debug_reverse_majority_50_easy_rule_50_difficult'
    export RAY_HEAD_PORT=6388
elif [ "$TRAINING_MODE" = "MODE2" ]; then
    export DEBUG=False
    export EXPERIMENT_NAME=prod_reverse_majority_50_easy_rule_50_difficult
    export PROJECT_NAME='prod_reverse_majority_50_easy_rule_50_difficult'
    export RAY_HEAD_PORT=6388
else  # MODE3
    export DEBUG=False
    export EXPERIMENT_NAME=remote_reverse_majority_50_easy_rule_50_difficult
    export PROJECT_NAME='remote_reverse_majority_50_easy_rule_50_difficult'
    export RAY_HEAD_PORT=6396
fi

# TTRL Configuration for Majority Voting (Easy Problems Only)
# TTRL is automatically enabled for easy problems (0-9) in reverse hybrid mode
if [ "$TRAINING_MODE" = "MODE1" ]; then
...
if [ "$TRAINING_MODE" = "MODE1" ]; then
    ...
    BASE_SAVE_PATH="/local2/salman/co_train_qwen_2_5_math/reverse_easy_50_majority_hard_50_rule"
else
    BASE_SAVE_PATH="/checkpoints/salsrahm-sandbox/novel_hybrid/reverse_easy_50_majority_hard_50_rule"
fi
