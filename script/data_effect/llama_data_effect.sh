...
export BASE_MODEL=/local2/salman/model/reward_signal_project/Llama-3.2-3B-Instruct # Path of your base policy model # CHANGE THIS
...
export EXPERIMENT_NAME=llama_data_2048 # CHANGE THIS NAME

TOTAL_EPOCHS=16 # CHANGE THIS (496 for 64, 248 for 128, 124 for 256, 62 for 512, 31 for 1024, 15 for 2048) 
SAVE_FREQ=50
TEST_FREQ=20
...
if [ "$DEBUG" = "True" ]; then
TRAIN_DATA_PATH="$(pwd)/data/math/train/llama-3b/llama_sky_math_2048.parquet"
...
TRAIN_DATA_PATH="$(pwd)/data/math/train/llama-3b/llama_sky_math_2048.parquet" # CHANGE THIS
