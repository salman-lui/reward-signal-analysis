#!/bin/bash
# VERL training script for SCP dataset with Llama-3.2-3B-Instruct
# Training: SCP balanced difficulty samples | Evaluation: Multiple benchmarks
#
# Usage:
#   DEBUG=True bash script/data_effect/scp/llama_data_effect_scp.sh   # Debug: 1 GPU, small batch
#   DEBUG=False bash script/data_effect/scp/llama_data_effect_scp.sh  # Production: 4 GPUs, full batch
...
export BASE_MODEL=/local2/salman/model/reward_signal_project/Llama-3.2-3B-Instruct # CHANGE THIS
