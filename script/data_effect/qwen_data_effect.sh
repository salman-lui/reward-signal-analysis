...
export BASE_MODEL=/local2/salman/model/reward_signal_project/Qwen2.5-Math-1.5B # CHANGE THIS
...
export EXPERIMENT_NAME=qwen_data_128 # CHANGE THIS

TOTAL_EPOCHS=248 # CHANGE THIS (496 for 64, 248 for 128, 124 for 256, 62 for 512, 31 for 1024, 15 for 2048, 7 for 4096)
SAVE_FREQ=50
TEST_FREQ=20
...
if [ "$DEBUG" = "True" ]; then
TRAIN_DATA_PATH="$(pwd)/data/math/train/qwen-1-5b/qwen_sky_math_128.parquet"
...
TRAIN_DATA_PATH="$(pwd)/data/math/train/qwen-1-5b/qwen_sky_math_128.parquet" # CHANGE THIS
