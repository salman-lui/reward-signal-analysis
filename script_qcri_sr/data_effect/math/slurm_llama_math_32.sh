...
# =============================================================================
# EXPERIMENT_NAME: llama_math_32
# DATASET: data/math/train/llama-3b/llama_sky_math_32_upsample.parquet
# TOTAL_EPOCHS: 496
# =============================================================================

# GPU Options: Uncomment ONE set below

# Option 1: A100 GPUs (currently active)
...
#SBATCH --mem=300GB
#SBATCH --job-name=llama_math_32
#SBATCH --mail-type=END
#SBATCH --mail-user=salman@nyu.edu
#SBATCH --output=/export/alt-ai-agent/salman/slurm_log/llama_math_32_%j.out
#SBATCH --error=/export/alt-ai-agent/salman/slurm_log/llama_math_32_%j.err
...
# =============================================================================
EXPERIMENT_NAME="llama_math_32"
DATASET_FILE="data/math/train/llama-3b/llama_sky_math_32_upsample.parquet"
TOTAL_EPOCHS=496
