...
# =============================================================================
# EXPERIMENT_NAME: llama_math_8
# DATASET: data/math/train/llama-3b/llama_sky_math_8_upsample.parquet
# TOTAL_EPOCHS: 496
# =============================================================================
...
#SBATCH --mem=300GB
#SBATCH --job-name=llama_math_8
#SBATCH --mail-type=END
#SBATCH --mail-user=salman@nyu.edu
#SBATCH --output=/export/alt-ai-agent/salman/slurm_log/llama_math_8_%j.out
#SBATCH --error=/export/alt-ai-agent/salman/slurm_log/llama_math_8_%j.err
...
# =============================================================================
EXPERIMENT_NAME="llama_math_8"
DATASET_FILE="data/math/train/llama-3b/llama_sky_math_8_upsample.parquet"
TOTAL_EPOCHS=496
